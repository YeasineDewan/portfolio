      ...
      <div className="flex flex-wrap justify-center gap-3 mb-8">
        {categories.map(category => (
          <button
            ...
            className={`px-4 py-2 rounded-full border text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 ${
              filter === category
                ? 'bg-primary text-white border-primary'
                : 'text-foreground-600 border-foreground-300 hover:bg-content2 dark:text-foreground-300 dark:border-foreground-700'
            }`}
          >
            {category}
          </button>
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-blue-400 hover:glow-blue card-hover">
              ...
              <CardBody className="text-center">
                ...
                <Button 
                  ...
                  className="bg-blue-600 text-white hover:bg-blue-700 hover:shadow-lg hover:scale-105 transition-all duration-200 btn-hover-effect"
                >
                  View Projects
                </Button>
              </CardBody>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-green-400 hover:glow-green card-hover">
              ...
              <CardBody className="text-center">
                ...
                <Button 
                  ...
                  className="bg-green-600 text-white hover:bg-green-700 hover:shadow-lg hover:scale-105 transition-all duration-200 btn-hover-effect"
                >
                  View Projects
                </Button>
              </CardBody>
            ...
            <Card className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-red-400 hover:glow-red card-hover">
              ...
              <CardBody className="text-center">
                ...
                <Button 
                  ...
                  className="bg-red-600 text-white hover:bg-red-700 hover:shadow-lg hover:scale-105 transition-all duration-200 btn-hover-effect"
                >
                  View Projects
                </Button>
              </CardBody>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-purple-400 hover:glow-purple card-hover">
              ...
              <CardBody className="text-center">
                ...
                <Button 
                  ...
                  className="bg-purple-600 text-white hover:bg-purple-700 hover:shadow-lg hover:scale-105 transition-all duration-200 btn-hover-effect"
                >
                  View Projects
                </Button>
              </CardBody>
